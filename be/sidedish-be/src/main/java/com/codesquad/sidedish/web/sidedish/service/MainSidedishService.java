...
@Service
public class MainSidedishService {
    public SidedishCategoryRepository sidedishCategoryRepository;
    ImageRepository imageRepository;

    public MainSidedishService (SidedishCategoryRepository sidedishCategoryRepository, ImageRepository imageRepository) {
        this.sidedishCategoryRepository = sidedishCategoryRepository;
        this.imageRepository = imageRepository;
    }

    public List<ItemDTO> getMainSidedishList() {
        ...
        return sidedishCategoryRepository.findByNameIs("메인요리").getSidedishes()
