...
public class RecommendService {
    ...
    public RecommendService (SidedishCategoryRepository sidedishCategoryRepository, ImageRepository imageRepository) {
    ...
    public List<ItemDTO> getRecommendSidedishList() {
        ...
        return sidedishCategoryRepository.findByNameIs("추천요리").getSidedishes()
