...
public class SidedishDTO {
    ...
    public SidedishDTO(String detailHash, String image, String alt, List<String> deliveryType, String title, String description, Price nPrice, Price sPrice, List<String> badge) {
    ...
    public static SidedishDTO of(Sidedish sidedish, Map<Long, Image> images) {
        ItemDTOBuilder builder = SidedishDTO.builder()
    ...
    public static final class ItemDTOBuilder {
        ...
        public SidedishDTO build() {
            return new SidedishDTO(detailHash, image, alt, deliveryType, title, description, nPrice, sPrice, badge);
        }
    }
}
